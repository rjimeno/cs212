...
# Changes and additions to the original code appear below only.
...
def timedcalls(n, fn, *args):
    ...
    print(f"The function was timed exactly {len(times)}.", file=sys.stderr)
    return min(times), average(times), max(times)

if __name__ == "__main__":
  print(zebra_puzzle())
  print()
  print(timedcalls(10000, zebra_puzzle, ))
  print(timedcalls(0.1, zebra_puzzle, ))
  print()
